...
@st.cache_data(ttl=300)  # ระบบจำข้อมูลในหน่วยความจำ 5 นาที ป้องกันการยิงซ้ำซ้อน
def get_cached_stock_data(ticker, start, end):
    import requests
    
    # สร้างเซสชันพร้อมจำลองโครงสร้างหัวไฟล์ (Headers) ให้เหมือนเบราว์เซอร์จริงยุคปัจจุบัน
    ...
    # ดึงข้อมูลผ่านเซสชันที่มีการจำลองตัวตนอย่างสมบูรณ์
